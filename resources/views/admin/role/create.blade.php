...
<div class="container-fluid px-3 px-lg-2 py-4">
    ...
    <form class="panel needs-validation" action="{{ route('role.store') }}" method="POST" novalidate>
        @csrf
        <section class="row g-3">
            <div class="col-12 col-xl-6">
                ...
                <div class="panel-header">
                    <div>
                        <h2 class="h5 mb-1 section-title"><i class="bi bi-person-fill-gear"></i></i><span>Add
                                Role</span>
                        </h2>
                ...
                <div class="row g-3">
                    <div class="col-md-12"><label class="form-label">Role Name<span
                                class="text-danger">*</span></label><input class="form-control" name="name" type="text"
                            required>
                ...
                <div class="d-flex flex-wrap justify-content-end gap-2 mt-4">
                    ...
                    <button class="btn btn-primary" type="submit"><i class="bi bi-person-fill-gear"></i> Add
                        Role</button></div>
