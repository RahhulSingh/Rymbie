...
@section('title', isset($hero) ? 'Edit Hero section' : 'Add Hero section')
...
<div class="container-fluid px-3 px-lg-2 py-4">
    ...
    <form class="panel needs-validation"
        action="{{ isset($hero) ? route('hero_section.update',$hero->id) : route('hero_section.store') }}"
        method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if(isset($hero) && $hero->image)
                            <div class="mt-3">
                                <img src="{{ asset('uploads/hero_section/'.$hero->image) }}"
                                    width="120"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="content"
                            id="content"
                            class="form-control">{{ old('content', $hero->content ?? '') }}</textarea>
