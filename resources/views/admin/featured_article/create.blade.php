...
@section('title', isset($article) ? 'Edit Featured Article' : 'Add Featured Article')
...
<div class="container-fluid px-3 px-lg-2 py-4">
    ...
    <div class="page-heading">
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <h1 class="h3 mb-1">
                    {{ isset($article) ? 'Edit Featured Article' : 'Add Featured Article' }}
                </h1>
            </div>
        </div>
        ...
        <div class="heading-actions">
            <a class="btn btn-outline-secondary btn-sm"
                href="{{ route('featured_article.index') }}">
    ...
    <form class="panel needs-validation"
        action="{{ isset($article) ? route('featured_article.update', $article->id) : route('featured_article.store') }}"
        method="POST"
